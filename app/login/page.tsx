...
//         return;
//       }
//         // Step 1: login API already called

// // Step 2: ab user fetch karo
...
// // Step 3: context update karo
// if (userRes.ok) {
//   login(userData.data)   // 🔥 IMPORTANT LINE
//   router.replace("/")
// }
//       router.replace("/")
      
//       setMessage("Login successful. Check your email to verify.");
//     } catch (err) {
