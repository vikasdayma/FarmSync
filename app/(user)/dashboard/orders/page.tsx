...
//               <StatCard label="Total Orders" value={orders.length} color="#1a1a1a" />
//               {/* <StatCard label="Total Revenue" value={`₹${totalRevenue.toLocaleString('en-IN')}`} color="#b8860b" /> */}
...
//               <p style={{ fontSize: '1rem', color: '#aaa', fontFamily: 'Georgia, serif', fontStyle: 'italic' }}>
//                 {filter === 'ALL' ? 'No sales yet.' : `No ${filter.toLowerCase()} orders.`}
//               </p>
//             </div>
//           )}
