...
const MOBILE_NAV_LINKS: NavLink[] = [
  ...
  { id: 2, label: "Orders", href: "/dashboard/orders" },
  { id: 3, label: "Alerts", href: "/dashboard/notification" },
  { id: 4, label: "Marketplace", href: "/marketplace" },
];
      ...
      <nav className="fixed top-0 right-0 h-dvh w-[75%] max-w-[300px] bg-white z-50 shadow-xl flex flex-col animate-in slide-in-from-right duration-300">
        ...
        <div className="mt-auto px-3 py-4 border-t border-gray-100 flex flex-col gap-1">
          ...
          <button
            ...
            className="text-left px-4 py-3 rounded-lg text-[15px] font-medium text-red-600 hover:bg-red-50 transition-colors"
          >
            Logout
          </button>
        </div>
